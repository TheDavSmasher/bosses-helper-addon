...
---@default endY
function helpers.cassetteFlyTo(endX, endY, controlX, controlY) end
...
---@default endY
function helpers.cassetteFly(endX, endY, controlX, controlY) end
...
---Change the Boss' hurtboxes to those stored under the given tag.
---@param tag string The hurtbox group tag to use.
function helpers.changeKillColliderTo(tag) end
...
---@param func function
---@return IEnumerator
function helpers.funcToIEnumerator(func) end
...
function helpers.getLuaCoroutine(func) end
...
function helpers.getEntityCollider(entityType, func, collider) end
...
function helpers.getEntityColliderByComponent(entityType, func, collider) end
...
---@return Ease.Easer
function helpers.funcToEaser(func) end

---Transform a Ease.Easer function into its C# counterpart.
---@param func L_Collision
---@return Collision
function helpers.funcToCollision(func) end

---Transform a Ease.Easer function into its C# counterpart.
---@param func L_DashCollision
---@return DashCollision
function helpers.funcToDashCollision(func) end
...
function helpers.waitWhile(predicate) end
...
getLuaAsset = helpers.getLuaAsset
log = helpers.log
...
changeKillColliderTo = helpers.changeKillColliderTo
...
funcToIEnumerator = helpers.funcToIEnumerator
getLuaCoroutine = helpers.getLuaCoroutine
getEntityCollider = helpers.getEntityCollider
getEntityColliderByComponent = helpers.getEntityColliderByComponent
...
funcToEaser = helpers.funcToEaser
funcToCollision = helpers.funcToCollision
funcToDashCollision = helpers.funcToDashCollision
